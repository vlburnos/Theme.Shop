...
if ($exists <= 2) {
	switch ($modx->getOption('manager_language')) {
		case 'ru':
			$output = 'Этот компонент требует <b>pdoTools</b>, <b>MinifyX</b>, <b>miniShop2</b>, <b>Ace</b>, <b>DateAgo</b> для быстрой и удобной работы.<br/><br/>Могу я автоматически скачать и установить их?';
			break;
		default:
			$output = 'This component requires <b>pdoTools</b>, <b>MinifyX</b>, <b>miniShop2</b>, <b>Ace</b>, <b>DateAgo</b> for fast and easy work.<br/><br/>Can i automaticly download and install them?';
	}
}
if ($chunks) {
	if (!$exists) {
